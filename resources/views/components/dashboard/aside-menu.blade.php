<div class="col-span-12 md:col-span-5 lg:col-span-3 bg-gray-800 text-white">
    <ul class="h-full flex flex-col items-start">
        <li class="self-center bg-gray-900 w-full h-20 flex items-center justify-center">
            <h1>CRM</h1>
        </li>
        <li class="w-full">
